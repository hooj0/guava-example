...
/**
 * An {@link ClusterException} is a data structure that allows for some code to "throw multiple exceptions", or
 * something close to it. The prototypical code that calls for this class is presented below:
 *
 * <pre>
...
final class ClusterException extends RuntimeException {
	 ...
	 * <ul>
	 * <li>If {@code exceptions} has a single exception and that exception is a {@link RuntimeException}, return it
	 * <li>If {@code exceptions} has a single exceptions and that exceptions is <em>not</em> a {@link RuntimeException},
	 * return a simple {@code RuntimeException} that wraps it
	 * <li>Otherwise, return an instance of {@link ClusterException} that wraps the first exception in the
	 * {@code exceptions} collection.
	 * </ul>
	 * <p>
	 * Though this method takes any {@link Collection}, it often makes most sense to pass a {@link java.util.List} or
	 * some other collection that preserves the order in which the exceptions got added.
	 *
	 * @throws NullPointerException
	 *             if {@code exceptions} is null
	 * @throws IllegalArgumentException
	 *             if {@code exceptions} is empty
	 */
