...
public class TestLogHandler extends Handler {
	...
	/*
	 * TODO(cpovirk): consider higher-level APIs here (say, assertNoRecordsLogged(), getOnlyRecordLogged(),
	 * getAndClearLogRecords()...) TODO(cpovirk): consider renaming this method to reflect that it takes a snapshot
	 * (and/or return an ImmutableList)
	 */
