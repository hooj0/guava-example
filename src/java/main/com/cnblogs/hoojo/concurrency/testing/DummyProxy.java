...
abstract class DummyProxy {
	...
	/**
	 * Returns a new proxy for {@code interfaceType}. Proxies of the same interface are equal to each other if the
	 * {@link DummyProxy} instance that created the proxies are equal.
	 */
